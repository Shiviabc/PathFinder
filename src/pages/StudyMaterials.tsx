...
const studyMaterials: StudyMaterial[] = [
  {
    ...
    rating: 4.8,
    downloads: 12500,
    description: "Comprehensive physics notes covering all topics for Class 12 CBSE curriculum",
    url: "#",
  ...
  },
  {
    ...
    downloads: 8900,
    duration: "12 hours",
    description: "Complete video series on organic chemistry with practical examples",
    url: "#",
  ...
  },
  {
    ...
    downloads: 5600,
    duration: "8 hours",
    description: "Audio lectures covering business studies concepts and case studies",
    url: "#",
  ...
  },
  {
    ...
    rating: 4.7,
    downloads: 7800,
    description: "In-depth analysis of major literary works and writing techniques",
    url: "#",
  ...
  },
  {
    ...
    rating: 4.5,
    downloads: 3400,
    description: "Comprehensive online resource with interactive graphs and examples",
...
export default function StudyMaterials() {
  ...
  const filteredMaterials = studyMaterials.filter(material => {
    ...
    const matchesStream = selectedStream === "all" || material.stream.toLowerCase() === selectedStream.toLowerCase();
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case 'pdf': return 'bg-primary text-primary-foreground';
      case 'video': return 'bg-secondary text-secondary-foreground';
      case 'audio': return 'bg-accent text-accent-foreground';
      case 'link': return 'bg-muted-foreground text-background';
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredMaterials.map((material) => (
          <Card key={material.id} className="shadow-medium hover:shadow-strong transition-all duration-300 hover:-translate-y-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-2 border-t border-border">
                <p className="text-sm text-muted-foreground mb-3">
                  By: <span className="font-medium text-foreground">{material.author}</span>
                </p>
      ...
      {filteredMaterials.length === 0 && (
        <Card className="text-center py-12">
          <CardContent>
            ...
            <CardTitle className="text-xl text-foreground mb-2">No materials found</CardTitle>
            <CardDescription>
      ...
      {/* Featured Section */}
      <Card className="mt-12 shadow-strong bg-gradient-to-r from-primary/5 to-secondary/5">
        <CardHeader>
          <CardTitle className="text-2xl text-foreground">Need More Help?</CardTitle>
          <CardDescription className="text-lg">
            Get personalized study recommendations based on your career goals
          </CardDescription>
        </CardHeader>
        <CardContent>
