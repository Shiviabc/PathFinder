...
import { BarChart3, Plus, X, Star, MapPin, GraduationCap, Users, DollarSign } from "lucide-react";
...
const availableColleges: College[] = [
  {
    ...
    facilities: ["Research Labs", "Hostel", "Sports Complex", "Medical Center", "Library"],
    placements: {
      percentage: 95,
  ...
  },
  {
    ...
    facilities: ["Modern Campus", "Industry Partnerships", "Placement Cell", "International Programs", "Hostels"],
    placements: {
      percentage: 85,
  ...
  },
  {
    ...
    facilities: ["Central Library", "Hostels", "Medical Center", "Sports Facilities", "Mosque"],
    placements: {
      percentage: 80,
...
export default function Compare() {
  ...
  const getComparisonValue = (college: College, key: string) => {
    switch (key) {
      case "type":
        return <Badge variant={college.type === 'Government' ? 'default' : 'secondary'}>{college.type}</Badge>;
      case "rating":
        return (
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {selectedColleges.length >= 2 && (
        <Card className="shadow-strong">
          <CardHeader>
            <CardTitle className="text-xl text-foreground">Detailed Comparison</CardTitle>
            <CardDescription>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    {selectedColleges.map((college) => (
                      <th key={college.id} className="text-left p-3 font-semibold text-foreground min-w-[200px]">
                        <div>
      ...
      {selectedColleges.length === 0 && (
        <Card className="text-center py-12">
          <CardContent>
            ...
            <CardTitle className="text-xl text-foreground mb-2">No colleges selected</CardTitle>
            <CardDescription>
      ...
      {selectedColleges.length === 1 && (
        <Card className="text-center py-12 bg-primary/5">
          <CardContent>
            ...
            <CardTitle className="text-xl text-foreground mb-2">Add one more college</CardTitle>
            <CardDescription>
